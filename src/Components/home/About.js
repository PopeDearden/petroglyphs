        ...
        return (
            <div className="About">
                ...
                <div className="Home-text">
                    ...
                    <p>How does technoglyph work?</p>
                    <p>Technoglyph accesses a database containing information about each petroglyph location. The database additionally contains data on each individual symbol found at each location. The information in the database can only be altered or added to by Taylor Dearden, the creator of Technoglyph.</p>
                    <p>What can I as a guest use Technoglyph for?</p>
                    <p>Guests can use the Library to sort through symbols based on attributes. This is especially useful for research to be able to identify patterns in the petroglyphs.</p>
                    <p>Guests can additionally view petroglyph locations on the google map API, and filter through those locations to find symbols with particular attributes.</p>
                </div>
